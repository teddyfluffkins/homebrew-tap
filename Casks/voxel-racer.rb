cask "voxel-racer" do
  ...
  url "https://github.com/teddyfluffkins/homebrew-tap/releases/download/voxel-racer-v#{version}/voxel-racer-v#{version}-macos-unsigned.zip"
  name "Voxel Racer"
  desc "Small-voxel 3D driving parcours game"
  homepage "https://github.com/teddyfluffkins/homebrew-tap"

  livecheck do
    url "https://github.com/teddyfluffkins/homebrew-tap/releases"
    regex(/href=.*?voxel-racer-v?(\d+(?:\.\d+)+)/i)
    strategy :page_match
  end
